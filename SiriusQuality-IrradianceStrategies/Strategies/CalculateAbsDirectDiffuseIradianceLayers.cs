...
namespace INRA.SiriusQualityIrradiance.Strategies
{
	...
	/// <summary>
	///Class CalculateAbsDirectDiffuseIradianceLayers
    /// Calculate diffuse and direct irradiance absorbed by the layers of the canopy
    /// </summary>
	public class CalculateAbsDirectDiffuseIradianceLayers : IStrategySiriusQualityIrradiance
	{

	#region Constructor

			public CalculateAbsDirectDiffuseIradianceLayers()
			{
				...
				pd1.PropertyName = "k_dif";
				pd1.PropertyType = (( INRA.SiriusQualityIrradiance.Interfaces.StatesVarInfo.k_dif)).ValueType.TypeForCurrentValue;
				pd1.PropertyVarInfo =( INRA.SiriusQualityIrradiance.Interfaces.StatesVarInfo.k_dif);
				_inputs0_0.Add(pd1);
				PropertyDescription pd2 = new PropertyDescription();
				pd2.DomainClassType = typeof(INRA.SiriusQualityIrradiance.Interfaces.States);
				pd2.PropertyName = "k_dir";
				pd2.PropertyType = (( INRA.SiriusQualityIrradiance.Interfaces.StatesVarInfo.k_dir)).ValueType.TypeForCurrentValue;
				pd2.PropertyVarInfo =( INRA.SiriusQualityIrradiance.Interfaces.StatesVarInfo.k_dir);
				_inputs0_0.Add(pd2);
				PropertyDescription pd3 = new PropertyDescription();
				pd3.DomainClassType = typeof(INRA.SiriusQualityIrradiance.Interfaces.States);
				pd3.PropertyName = "rhoCanopyDiff";
				pd3.PropertyType = (( INRA.SiriusQualityIrradiance.Interfaces.StatesVarInfo.rhoCanopyDiff)).ValueType.TypeForCurrentValue;
				pd3.PropertyVarInfo =( INRA.SiriusQualityIrradiance.Interfaces.StatesVarInfo.rhoCanopyDiff);
				_inputs0_0.Add(pd3);
				...
				pd5.PropertyName = "layersGAI";
				pd5.PropertyType = (( INRA.SiriusQualityIrradiance.Interfaces.StatesVarInfo.layersGAI)).ValueType.TypeForCurrentValue;
				pd5.PropertyVarInfo =( INRA.SiriusQualityIrradiance.Interfaces.StatesVarInfo.layersGAI);
				_inputs0_0.Add(pd5);
	...
	#region Implementation of IAnnotatable
			...
			{
				get { return "Calculate diffuse and direct irradiance absorbed by the layers of the canopy"; }
			}
	...
	#region pre/post conditions management		
			...
			public string TestPreConditions(INRA.SiriusQualityIrradiance.Interfaces.Rates rates,INRA.SiriusQualityIrradiance.Interfaces.Exogenous exogenous,INRA.SiriusQualityIrradiance.Interfaces.States states, string callID)
			{
				try
				{
					...
					if(r1.ApplicableVarInfoValueTypes.Contains( INRA.SiriusQualityIrradiance.Interfaces.StatesVarInfo.k_dif.ValueType)){prc.AddCondition(r1);}
					RangeBasedCondition r2 = new RangeBasedCondition(INRA.SiriusQualityIrradiance.Interfaces.StatesVarInfo.k_dir);
					if(r2.ApplicableVarInfoValueTypes.Contains( INRA.SiriusQualityIrradiance.Interfaces.StatesVarInfo.k_dir.ValueType)){prc.AddCondition(r2);}
					RangeBasedCondition r3 = new RangeBasedCondition(INRA.SiriusQualityIrradiance.Interfaces.StatesVarInfo.rhoCanopyDiff);
					if(r3.ApplicableVarInfoValueTypes.Contains( INRA.SiriusQualityIrradiance.Interfaces.StatesVarInfo.rhoCanopyDiff.ValueType)){prc.AddCondition(r3);}
					...
					if(r5.ApplicableVarInfoValueTypes.Contains( INRA.SiriusQualityIrradiance.Interfaces.StatesVarInfo.layersGAI.ValueType)){prc.AddCondition(r5);}
