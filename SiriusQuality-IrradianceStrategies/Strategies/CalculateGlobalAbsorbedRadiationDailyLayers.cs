...
namespace INRA.SiriusQualityIrradiance.Strategies
{
	...
	/// <summary>
	///Class CalculateGlobalAbsorbedRadiationDailyLayers
    /// Calculate global absorbed radiation Daily leaf layer by leaf layer
    /// </summary>
	public class CalculateGlobalAbsorbedRadiationDailyLayers : IStrategySiriusQualityIrradiance
	{
	...
	#region Implementation of IAnnotatable
			...
			{
				get { return "Calculate global absorbed radiation Daily leaf layer by leaf layer"; }
			}
    ...
    #region Instances of the parameters
			...
			{ 
				get {
						...
						else throw new Exception("Parameter 'Kl' not found (or found null) in strategy 'CalculateGlobalAbsorbedRadiationDailyLayers'");
				 } set {
							VarInfo vi = _modellingOptionsManager.GetParameterByName("Kl");
							if (vi != null)  vi.CurrentValue=value;
						else throw new Exception("Parameter 'Kl' not found in strategy 'CalculateGlobalAbsorbedRadiationDailyLayers'");
				}
			}
