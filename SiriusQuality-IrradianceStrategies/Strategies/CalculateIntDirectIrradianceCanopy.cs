...
namespace INRA.SiriusQualityIrradiance.Strategies
{
	...
	/// <summary>
	///Class CalculateIntDirectIrradianceCanopy
    /// Calculate the fraction of direct light
    /// </summary>
	public class CalculateIntDirectIrradianceCanopy : IStrategySiriusQualityIrradiance
	{

	#region Constructor

			public CalculateIntDirectIrradianceCanopy()
			{
				...
				VarInfo v1 = new VarInfo();
				 v1.DefaultValue = 0;
				 v1.Description = "0:Ellipdoildale leaf angle distribution, 1 Spherical";
				 v1.Id = 0;
				 v1.MaxValue = 1;
				 v1.MinValue = 0;
				...
				pd2.PropertyName = "layersGAI";
				pd2.PropertyType = (( INRA.SiriusQualityIrradiance.Interfaces.StatesVarInfo.layersGAI)).ValueType.TypeForCurrentValue;
				pd2.PropertyVarInfo =( INRA.SiriusQualityIrradiance.Interfaces.StatesVarInfo.layersGAI);
				_inputs0_0.Add(pd2);
				...
				pd4.PropertyName = "rhoLeaf";
				pd4.PropertyType = (( INRA.SiriusQualityIrradiance.Interfaces.StatesVarInfo.rhoLeaf)).ValueType.TypeForCurrentValue;
				pd4.PropertyVarInfo =( INRA.SiriusQualityIrradiance.Interfaces.StatesVarInfo.rhoLeaf);
				_inputs0_0.Add(pd4);
				PropertyDescription pd5 = new PropertyDescription();
				pd5.DomainClassType = typeof(INRA.SiriusQualityIrradiance.Interfaces.States);
				pd5.PropertyName = "tauLeaf";
				pd5.PropertyType = (( INRA.SiriusQualityIrradiance.Interfaces.StatesVarInfo.tauLeaf)).ValueType.TypeForCurrentValue;
				pd5.PropertyVarInfo =( INRA.SiriusQualityIrradiance.Interfaces.StatesVarInfo.tauLeaf);
				_inputs0_0.Add(pd5);
				...
				pd6.PropertyName = "fiPARb";
				pd6.PropertyType =  (( INRA.SiriusQualityIrradiance.Interfaces.StatesVarInfo.fiPARb)).ValueType.TypeForCurrentValue;
				pd6.PropertyVarInfo =(  INRA.SiriusQualityIrradiance.Interfaces.StatesVarInfo.fiPARb);
				_outputs0_0.Add(pd6);
	...
	#region Implementation of IAnnotatable
			...
			{
				get { return "Calculate the fraction of direct light"; }
			}
    ...
    #region Instances of the parameters
			...
			{ 
				get {
						...
						else throw new Exception("Parameter 'useSphericalLeafDistrib' not found (or found null) in strategy 'CalculateIntDirectIrradianceCanopy'");
				 } set {
							VarInfo vi = _modellingOptionsManager.GetParameterByName("useSphericalLeafDistrib");
							if (vi != null)  vi.CurrentValue=value;
						else throw new Exception("Parameter 'useSphericalLeafDistrib' not found in strategy 'CalculateIntDirectIrradianceCanopy'");
				}
			}
			public Double CI
			{ 
				get {
						...
						else throw new Exception("Parameter 'CI' not found (or found null) in strategy 'CalculateIntDirectIrradianceCanopy'");
				 } set {
							VarInfo vi = _modellingOptionsManager.GetParameterByName("CI");
							if (vi != null)  vi.CurrentValue=value;
						else throw new Exception("Parameter 'CI' not found in strategy 'CalculateIntDirectIrradianceCanopy'");
				}
			}
	...
	#region Static parameters VarInfo definition
			...
			{                                
				...
				useSphericalLeafDistribVarInfo.Description =" 0:Ellipdoildale leaf angle distribution, 1 Spherical";
				useSphericalLeafDistribVarInfo.MaxValue = 1;
				useSphericalLeafDistribVarInfo.MinValue = 0;
				useSphericalLeafDistribVarInfo.DefaultValue = 0;
	...
	#region pre/post conditions management		
			...
			public string TestPostConditions(INRA.SiriusQualityIrradiance.Interfaces.Rates rates,INRA.SiriusQualityIrradiance.Interfaces.Exogenous exogenous,INRA.SiriusQualityIrradiance.Interfaces.States states, string callID)
			{
				try
				{
					...
					INRA.SiriusQualityIrradiance.Interfaces.StatesVarInfo.fiPARb.CurrentValue=states.fiPARb;
					...
					RangeBasedCondition r6 = new RangeBasedCondition(INRA.SiriusQualityIrradiance.Interfaces.StatesVarInfo.fiPARb);
					if(r6.ApplicableVarInfoValueTypes.Contains( INRA.SiriusQualityIrradiance.Interfaces.StatesVarInfo.fiPARb.ValueType)){prc.AddCondition(r6);}
			...
			public string TestPreConditions(INRA.SiriusQualityIrradiance.Interfaces.Rates rates,INRA.SiriusQualityIrradiance.Interfaces.Exogenous exogenous,INRA.SiriusQualityIrradiance.Interfaces.States states, string callID)
			{
				try
				{
					...
					INRA.SiriusQualityIrradiance.Interfaces.ExogenousVarInfo.solarElevation.CurrentValue=exogenous.solarElevation;
					...
					RangeBasedCondition r1 = new RangeBasedCondition(INRA.SiriusQualityIrradiance.Interfaces.ExogenousVarInfo.solarElevation);
					if(r1.ApplicableVarInfoValueTypes.Contains( INRA.SiriusQualityIrradiance.Interfaces.ExogenousVarInfo.solarElevation.ValueType)){prc.AddCondition(r1);}
					RangeBasedCondition r2 = new RangeBasedCondition(INRA.SiriusQualityIrradiance.Interfaces.StatesVarInfo.layersGAI);
					if(r2.ApplicableVarInfoValueTypes.Contains( INRA.SiriusQualityIrradiance.Interfaces.StatesVarInfo.layersGAI.ValueType)){prc.AddCondition(r2);}
					...
					RangeBasedCondition r4 = new RangeBasedCondition(INRA.SiriusQualityIrradiance.Interfaces.StatesVarInfo.rhoLeaf);
					if(r4.ApplicableVarInfoValueTypes.Contains( INRA.SiriusQualityIrradiance.Interfaces.StatesVarInfo.rhoLeaf.ValueType)){prc.AddCondition(r4);}
					RangeBasedCondition r5 = new RangeBasedCondition(INRA.SiriusQualityIrradiance.Interfaces.StatesVarInfo.tauLeaf);
					if(r5.ApplicableVarInfoValueTypes.Contains( INRA.SiriusQualityIrradiance.Interfaces.StatesVarInfo.tauLeaf.ValueType)){prc.AddCondition(r5);}
	...
	#region Model
            ...
            double[] angles = new double[6] { 15.0, 30.0, 45.0, 60.0, 75.0, 90.0 };
            double[] anglesRad = new double[6];
            for (int ia = 0; ia < 6; ia++) anglesRad[ia] = angles[ia] * Math.PI / 180;
