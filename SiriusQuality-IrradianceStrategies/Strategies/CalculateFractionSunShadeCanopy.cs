...
namespace INRA.SiriusQualityIrradiance.Strategies
{
	...
	/// <summary>
	///Class CalculateFractionSunShadeCanopy
    /// Calculate the fraction of shaded and sunlit leaves of the canopy.
    /// </summary>
	public class CalculateFractionSunShadeCanopy : IStrategySiriusQualityIrradiance
	{

	#region Constructor

			public CalculateFractionSunShadeCanopy()
			{
	...
	#region Implementation of IAnnotatable
			...
			{
				get { return "Calculate the fraction of shaded and sunlit leaves of the canopy."; }
			}
	...
	#region Model
			...
			{				
                ...
                states.shadeFraction = I_shade_absDict; // absorbedSunlitIrradiance;
                states.sunlitFraction = I_sun_absDict; // absorbedShadedIrradiance
            ...
            private Tuple<Dictionary<int, double>, Dictionary<int, double>> HourlyAbsorbedIrradiance(double k1_dir,Dictionary<int, Tuple<double, double>> gaiDict)
            {
                ...
                Dictionary<int, double> f_shadeDict = new Dictionary<int, double>();
                    ...
                    double f_sun = Math.Max(0.000001, ((1 - Math.Exp(-k1_dir * gaiTotal)) / k1_dir)) / gaiTotal;
                    double f_shade = 1 - f_sun;


                    //***********************************

                    f_sunDict.Add(99, f_sun);
                    f_shadeDict.Add(99, f_shade);
