...
namespace INRA.SiriusQualityIrradiance.Strategies
{
	...
	/// <summary>
	///Class CalculateGlobalAbsorbedRadiationHourly
    /// Calculate global absorbed radiation hourly
    /// </summary>
	public class CalculateGlobalAbsorbedRadiationHourly : IStrategySiriusQualityIrradiance
	{
	...
	#region Implementation of IAnnotatable
			...
			{
				get { return "Calculate global absorbed radiation hourly"; }
			}
    ...
    #region Instances of the parameters
			...
			{ 
				get {
						...
						else throw new Exception("Parameter 'Kl' not found (or found null) in strategy 'CalculateGlobalAbsorbedRadiationHourly'");
				 } set {
							VarInfo vi = _modellingOptionsManager.GetParameterByName("Kl");
							if (vi != null)  vi.CurrentValue=value;
						else throw new Exception("Parameter 'Kl' not found in strategy 'CalculateGlobalAbsorbedRadiationHourly'");
				}
			}
	...
	#region Model
                 ...
                 Dictionary<int, Tuple<double, double>> gaiDict)
        {
            ...
            double TotGAI = gaiDict.Sum(x => x.Value.Item1 + x.Value.Item2);

            absorbedPAR = (I_dir + I_dif) * (1.0 - Math.Exp(-Kl * TotGAI)); // only lamina absorption is considered

            absDict.Add(99, absorbedPAR);
