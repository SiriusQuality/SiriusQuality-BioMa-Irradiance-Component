...
namespace INRA.SiriusQualityIrradiance.Strategies
{
	...
	/// <summary>
	///Class CalculateDirectExtinctionCoefBlakLeavesSphere
    /// Calculate the direct exttinction coefficient for theblack  leaves with spherical angle distribution (k1)
    /// </summary>
	public class CalculateDirectExtinctionCoefBlakLeavesSphere : IStrategySiriusQualityIrradiance
	{

	#region Constructor

			public CalculateDirectExtinctionCoefBlakLeavesSphere()
			{
	...
	#region Implementation of IAnnotatable
			...
			{
				get { return "Calculate the direct exttinction coefficient for theblack  leaves with spherical angle distribution (k1)"; }
			}
    ...
    #region Instances of the parameters
			...
			{ 
				get {
						...
						else throw new Exception("Parameter 'CI' not found (or found null) in strategy 'CalculateDirectExtinctionCoefBlakLeavesSphere'");
				 } set {
							VarInfo vi = _modellingOptionsManager.GetParameterByName("CI");
							if (vi != null)  vi.CurrentValue=value;
						else throw new Exception("Parameter 'CI' not found in strategy 'CalculateDirectExtinctionCoefBlakLeavesSphere'");
				}
			}
