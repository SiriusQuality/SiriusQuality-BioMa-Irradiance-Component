...
namespace INRA.SiriusQualityIrradiance.Strategies
{
	...
	/// <summary>
	///Class CalculateDirectExtinctionCoefBlakLeavesEllipse
    /// Calculate the direct exttinction coefficient for theblack  leaves with ellipsoïdal angle distribution
    /// </summary>
	public class CalculateDirectExtinctionCoefBlakLeavesEllipse : IStrategySiriusQualityIrradiance
	{
	...
	#region Implementation of IAnnotatable
			...
			{
				get { return "Calculate the direct exttinction coefficient for theblack  leaves with ellipsoïdal angle distribution"; }
			}
    ...
    #region Instances of the parameters
			...
			{ 
				get {
						...
						else throw new Exception("Parameter 'CI' not found (or found null) in strategy 'CalculateDirectExtinctionCoefBlakLeavesEllipse'");
				 } set {
							VarInfo vi = _modellingOptionsManager.GetParameterByName("CI");
							if (vi != null)  vi.CurrentValue=value;
						else throw new Exception("Parameter 'CI' not found in strategy 'CalculateDirectExtinctionCoefBlakLeavesEllipse'");
				}
			}
